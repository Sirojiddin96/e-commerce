...
function Adminpanel(){
    const {Amodal, AdminDeleteProduct, setAModal, Aprod, side, setSide, adminlog, setAdminlog} = useContext(ContextData);
            ...
            <div onClick={()=>setAModal(false)} className="ConfirmBack">
                <div onClick={(e)=>e.stopPropagation()} className="ConfirmContent">
                    ...
                    <div className="ConfirmContentAction">
                        <button onClick={()=>{AdminDeleteProduct(Aprod); setAModal(false)}}>Yes</button>
                        <button onClick={()=>setAModal(false)}>Cancel</button>
                    </div>
                </div>
            </div> : <></>
        }
        <>
        <div onClick={()=>setSide(false)} className={side ? "AdminSideBarBack Show" : "AdminideBarBack"}>
        </div>
        ...
        <div className="Adminpanel">
            <div className="AdminpanelTop">
                ...
                <div className="AdminlogShow">
                    ...
                    <div onClick={()=>setSide(true)} className="AdminMenuIconDiv">
                    <figure>
