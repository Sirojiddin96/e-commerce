...
function Search(){
    ...
    const {favorites, cart, priceAfterDiscount, productlist} = useContext(ContextData);
    return(
        <div className="SearchPage">
            <Header/>
            <div className="SearchInputDiv">
                <input onChange={(e)=>setSearch(e.target.value)} type="text" placeholder="Type in the product name" />
            </div>
