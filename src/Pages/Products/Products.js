...
function Products() {
    ...
    const onChangePage = (side) => {
        console.log(side);
    }

    const onPagerClick = (side) => {
        console.log(side);
    }
                        ...
                        <div className="ProductsSide">
                            ...
                            <div className='pagination-section'>
                                ...
                                <div className='pagination'>
                                    <div onClick={() => settingPage(page - 1)} className="paging">
                                        <img src={Prev} alt="prev" />
                                    </div>
                                    {pageNumbers.map(item => (item > range.beginnig - 2 && item < range.ending ?
                                        <div onClick={() => settingPage(item)} className={item === page ? "paging Active" : "paging"} key={item}>
                                ...
                                <div onClick={() => settingPage(lastPage)} className="paging">
